  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8 rounded-t-lg shadow-lg">
        <h2 className="text-3xl font-bold mb-3">🏗️ Presupest - Sistema Profesional de Presupuestos</h2>
        <p className="text-lg text-blue-50 leading-relaxed">
          ...
          Cálculo automático, formato impecable, cliente convencido. 
      ...
      <div className="bg-white shadow-md rounded-b-lg p-6">
        {success && (
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-md flex items-center">
            ...
            <span className="text-green-800">¡Presupuesto generado y enviado con éxito!</span>
          </div>
        )}
